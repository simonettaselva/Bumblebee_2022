################################################
# Statistical Models script INDIVIDUALS ZURICH
# by Simonetta Selva
#
...
BB22.bb.traits <- read_csv("BB22_traits.csv")%>%
  filter(location == "ZH") # filter for only Zurich entries
...
# add location names to data frame
for (i in 1:nrow(BB22.fun.ID)) {
  # i <- 1
  BB22.fun.ID$location[i] = substr(BB22.fun.ID$ID[i], nchar(BB22.fun.ID$ID[i])-5, nchar(BB22.fun.ID$ID[i])-4)
}
# filter for only Zurich entries
BB22.fun.ID <- filter(BB22.fun.ID, location == "ZH") 
...
plot <- ggarrange(plot_list[[1]],plot_list[[2]],
                  ...
                  ncol = 1, nrow = 6,
                  labels = c("A", "B", "C", "D"))
annotate_figure(plot, top = text_grob("B.pascuorum (ZH): species richness and funtional diversity across landscapes", 
                                      face = "bold", size = 22))
# ggsave("./functional diversity/pasc_ID/Zurich/FD_B.pascuorum_ID.png", width = 6, height = 24)
setwd(input)
...
for (i in metrics) {
  ...
  plot4 <- ggarrange(a1,a2,a3,a4,a5,a6,a7,a8,a9, # arrange to plots nicely and export them 
                     ...
                     common.legend = TRUE)
  annotate_figure(plot4, top = text_grob(paste("B.pascuorum (ZH): comparison of ", i, " and traits across landscapes", sep = ""),
                                         face = "bold", size = 22))
  ggsave(paste("./functional diversity/pasc_ID/Zurich/FD_pasc_corr_", i, "_BBtraits_landscapes.png", sep = ""), width = 16, height = 8)
  setwd(input)
} # end loop i
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/pasc_ID/Zurich/training and predicting/linear model/", i, "_lm_var_imp_pasc.png", sep = ""), width = 8, height = 5)
  setwd(input)
  ...
  ggsave(paste("./functional diversity/pasc_ID/Zurich/training and predicting/linear model/", i, "_lm_prediction_pasc.png", sep = ""), width = 8, height = 5)
  setwd(input)
} # end i loop
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/pasc_ID/Zurich/training and predicting/random forest/", i, "_rf_var_imp_pasc.png", sep = ""), width = 8, height = 8)
  setwd(input)
  ...
  ggarrange(gg_test, gg_train, ncol = 2, nrow = 1,
            labels = c("A", "B"), common.legend = TRUE, legend = "right")
  ggsave(paste("./functional diversity/pasc_ID/Zurich/training and predicting/random forest/", i, "_rf_prediction_pasc.png", sep = ""), width = 8, height = 5)
  setwd(input)
...
plot <- ggarrange(plot_list[[1]],plot_list[[2]],
                  ...
                  ncol = 1, nrow = 6,
                  labels = c("A", "B", "C", "D"))
annotate_figure(plot, top = text_grob("B.lapidarius (ZH): species richness and funtional diversity across landscapes", 
                                      face = "bold", size = 22))
# ggsave("./functional diversity/lapi_ID/Zurich/FD_B.lapidarius_ID.png", width = 6, height = 24)
setwd(input)
...
for (i in metrics) {
  ...
  plot4 <- ggarrange(a1,a2,a3,a4,a5,a6,a7,a8,a9, # arrange to plots nicely and export them 
                     ...
                     labels = c(LETTERS[1:9]),   
                     common.legend = TRUE)
  annotate_figure(plot4, top = text_grob(paste("B.lapidarius (ZH): comparison of ", i, " and traits across landscapes", sep = ""),
                                         face = "bold", size = 22))
  ggsave(paste("./functional diversity/lapi_ID/Zurich/FD_lapi_corr_", i, "_BBtraits_landscapes.png", sep = ""), width = 16, height = 8)
  setwd(input)
} # end loop i
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/lapi_ID/Zurich/training and predicting/linear model/", i, "_lm_var_imp_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
  ...
  ggarrange(gg_test, gg_train, ncol = 2, nrow = 1,
            labels = c("A", "B"), common.legend = TRUE, legend = "right")
  ggsave(paste("./functional diversity/lapi_ID/Zurich/training and predicting/linear model/", i, "_lm_prediction_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
} # end i loop
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/lapi_ID/Zurich/training and predicting/random forest/", i, "_rf_var_imp_lapi.png", sep = ""), width = 8, height = 8)
  setwd(input)
  ...
  ggarrange(gg_test, gg_train, ncol = 2, nrow = 1,
            labels = c("A", "B"), common.legend = TRUE, legend = "right")
  ggsave(paste("./functional diversity/lapi_ID/Zurich/training and predicting/random forest/", i, "_rf_prediction_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
