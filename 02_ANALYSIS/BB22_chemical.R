...
annotate_figure(plot, top = text_grob(paste("B.pascuorum: comparison of AS and FDs", sep = ""),
                                      face = "bold", size = 22))
ggsave(paste("./chemical/pasc_site/chemical_pasc_AS_BBtraits.png", sep = ""), width = 10, height = 10)
setwd(input)
...
ggplot(BB22.chem.site, aes(x=landscape, y = AS.mean, fill=landscape)) + 
  ...
  scale_fill_manual(values=palette.landscape, guide = "none") + 
  labs(subtitle = paste("p = ", w.test$p, sep=""))
ggsave(paste("./chemical/lapi_site/chemical_lapi_AS_landscapes.png", sep = ""), width = 8, height = 8)
setwd(input)
...
annotate_figure(plot, top = text_grob(paste("B.lapidarius: comparison of AS and traits across landscapes", sep = ""),
                                      face = "bold", size = 22))
ggsave(paste("./chemical/lapi_site/chemical_lapi_AS_BBtraits_landscapes.png", sep = ""), width = 10, height = 10)
setwd(input)
...
annotate_figure(plot, top = text_grob(paste("B.lapidarius: comparison of AS and FDs", sep = ""),
                                      face = "bold", size = 22))
ggsave(paste("./chemical/lapi_site/chemical_lapi_AS_BBtraits.png", sep = ""), width = 10, height = 10)
setwd(input)
