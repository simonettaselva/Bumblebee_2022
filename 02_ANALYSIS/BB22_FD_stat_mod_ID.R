...
annotate_figure(plot, top = text_grob("species richness and funtional diversity between species", 
                                      face = "bold", size = 22))
ggsave("./functional diversity/FD_box_BBtraits_species.png", width = 6, height = 24)
setwd(input)
...
setwd(output)
write.csv(w.stats.pasc,"./functional diversity/pasc_ID/FD_W_pasc_BBtraits_species.csv")
setwd(input)
...
w.stats.lapi <- rbind(c(mean.rural$sp_richn, mean.urban$sp_richn, w.test.list$sp_richn),
                      ...
                      c(mean.rural$fdiv, mean.urban$fdiv, w.test.list$fdiv))
setwd(output)
write.csv(w.stats.lapi,"./functional diversity/lapi_ID/FD_lapi_W_BBtraits_species.csv")
setwd(input)
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/lapi_ID/training and predicting/linear model/", i, "_lm_var_imp_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
  ...
  ggarrange(gg_test, gg_train, ncol = 2, nrow = 1,
            labels = c("A", "B"), common.legend = TRUE, legend = "right")
  ggsave(paste("./functional diversity/lapi_ID/training and predicting/linear model/", i, "_lm_prediction_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
} # end i loop
...
for (i in metrics) {
  ...
  setwd(output)
  ggsave(paste("./functional diversity/lapi_ID/training and predicting/random forest/", i, "_rf_var_imp_lapi.png", sep = ""), width = 8, height = 8)
  setwd(input)
  ...
  ggarrange(gg_test, gg_train, ncol = 2, nrow = 1,
            labels = c("A", "B"), common.legend = TRUE, legend = "right")
  ggsave(paste("./functional diversity/lapi_ID/training and predicting/random forest/", i, "_rf_prediction_lapi.png", sep = ""), width = 8, height = 5)
  setwd(input)
